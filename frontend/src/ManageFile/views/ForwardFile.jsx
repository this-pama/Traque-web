...
class Create extends React.Component {
  ...
  onSubmit = async (values) => {
    ...
    try {
      await axios
        .post(`/v1/file/forward/${id}/${userId}`, formData)
        .then(() => this.setState({ loading: false }));
      toast("File successfully forwarded", {
        closeOnClick: true,
        autoClose: 1000,
      });
            ...
            <Form
              ...
              render={({ values, onSave, valid, reset }) => (
                <form>
                  <Module noMargin>
                    <ModuleHeader>
                      <span style={{ fontSize: 20 }}>Forward file</span>
                    </ModuleHeader>
                    <ModuleBody>
                      <Col md={8} sm={8} xs={12}>
                        <FieldWrapper>
                      ...
                      <Col md={8} sm={8} xs={12}>
                        <FieldWrapper>
                          ...
                          >
                            {({ input, meta }) => (
                              <>
                                <div className="wfp--label wfp--label--disabled">
                                  File type
                                </div>
                                <Select
                    ...
                    <ModuleFooter>
                      ...
                      >
                        ...
                        <Button
                          ...
                          disabled={
                            values.designatedOfficer &&
                            values.designatedOfficer._id
                              ? false
                              : true
                          }
                        >
