...
class MainNav extends React.Component {
  ...
  loadOptions = _.debounce(
    async (input) => {
      if (input == undefined)
        return this.setState({ searching: false, searchResult: [] });
      ...
      axios
        .post(`/v1/file/search`, { name: input })
        .then((res) =>
          ...
          <Wrapper>
                  ...
                  subNavigation={
                    <SubNavigation>
                      <SubNavigationHeader>
                        ...
                        <SubNavigationLink>
                          <Button kind="primary" small onClick={() => logout()}>
                            Logout
                          </Button>
                        </SubNavigationLink>
                      </SubNavigationHeader>
            ...
            >
              ...
              {searchResult.length <= 0 && searching == false && (
                <p style={{ textAlign: "center" }}>No file found</p>
              )}
              ...
              >
                {searchResult.map((p, i) => (
                  <div
                    ...
                    onClick={() =>
                      this.setState({ startSearch: false, searchResult: [] })
                    }
                  >
