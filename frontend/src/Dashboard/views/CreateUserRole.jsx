...
class Create extends React.Component {
  ...
  setPermission = (e, p) => {
    ...
    if (e) {
      ...
      this.setState({ permission: permission.filter((perm) => perm != p) });
  };
  ...
  onSubmit = async (values) => {
    ...
    try {
      if (state && state.edit) {
        await axios
          .put(`/v1/role/update/${state.id}`, formData)
          .then(() => this.setState({ loading: false }));
        toast("Role successfully updated", {
          closeOnClick: true,
          autoClose: 1000,
        });
                ...
                <form>
                  <Module noMargin>
                    ...
                    <ModuleBody>
                      ...
                      <FieldWrapper>
                        <Field component={ReduxFormWrapper} name="permission">
                          {({ input, meta }) => (
                            <InputGroup
